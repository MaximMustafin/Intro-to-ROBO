...
(cl:defmethod cl:initialize-instance :after ((m <RobotStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_messages-msg:<RobotStatus> is deprecated: use custom_messages-msg:RobotStatus instead.")))
...
(cl:defmethod robot_id-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:robot_id-val is deprecated.  Use custom_messages-msg:robot_id instead.")
  (robot_id m))

(cl:ensure-generic-function 'is_ready-val :lambda-list '(m))
(cl:defmethod is_ready-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:is_ready-val is deprecated.  Use custom_messages-msg:is_ready instead.")
  (is_ready m))
